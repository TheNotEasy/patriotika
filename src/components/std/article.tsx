...
export default function Article({img, title, variant, ...divProps}: ArticleProps) {
  ...
  return <div className={tw(`flex ${vertical && 'flex-col w-full max-w-28 sm:max-w-56 gap-1'} ${horizontal && 'gap-5'} `) + divClassName} {...divProps}>
    <div className={tw(`rounded-xl overflow-hidden aspect-[323/253] bg-gray-300 ${horizontal && 'max-h-[165px] h-full'} ${vertical && 'w-full'}`)}>
